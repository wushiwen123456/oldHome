...
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 17));


var _detail = __webpack_require__(/*! @/network/detail */ 18);




var _dealUrl = __webpack_require__(/*! @/utils/dealUrl */ 19);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _toConsumableArray(arr) {return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread();}function _nonIterableSpread() {throw new TypeError("Invalid attempt to spread non-iterable instance");}function _iterableToArray(iter) {if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === "[object Arguments]") return Array.from(iter);}function _arrayWithoutHoles(arr) {if (Array.isArray(arr)) {for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) {arr2[i] = arr[i];}return arr2;}}
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    // 结算面板购物车ID储存
    keepCartId: function keepCartId(state, cartId) {
      state.cartId = [];
      if (cartId instanceof Array) {var _state$cartId;
        (_state$cartId = state.cartId).push.apply(_state$cartId, _toConsumableArray(cartId));
      } else {
    ...
    // 保存商品id
    keepShopId: function keepShopId(state, id) {
      state.shopId = id;
    },
    // 保存地址信息
    setAddress: function setAddress(state, item) {
      state.address = item;
    },
    // 秒杀id存储
    setSkillId: function setSkillId(state, id) {
      state.skillId = id;
    },
    // 立即支付方法
    payRightNow: function payRightNow(state, data) {
  ...
  actions: {
    // 提交订单方法
    Pay: function Pay(_ref, payload) {var commit = _ref.commit,state = _ref.state;
      return (0, _detail.payNow)(payload, state.userInfo.token);
    },
    // 收藏商品方法
    collect: function collect(_ref2, payload) {var commit = _ref2.commit,state = _ref2.state;
      return (0, _detail.collectProduct)(payload.id, payload.category, state.userInfo.token);
    },
    // 取消商品收藏
    unCollect: function unCollect(_ref3, payload) {var state = _ref3.state;
      return (0, _detail.unCollectProduct)(payload.id, payload.category, state.userInfo.token);
    } } });var _default =
...
/***/ 165:
/*!*****************************************!*\
  !*** D:/项目/oldHome/network/shopCart.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getShopCartData = getShopCartData;exports.removeCart = removeCart;exports.changeCartNum = changeCartNum;
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 17));

var _dealUrl = __webpack_require__(/*! @/utils/dealUrl */ 19);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 引入ajax
// 引入替换Url的方法
// 请求购物车列表
function getShopCartData(token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/auth_api/get_cart_list'),
    header: {
      token: token } });
...
// 删除购物车
function removeCart(ids, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/auth_api/remove_cart'),
    data: {
      ids: ids },
...
// 修改购物车数量
function changeCartNum(cartId, cartNum, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/auth_api/change_cart_num'),
    data: {
      cartId: cartId,
      cartNum: cartNum },
...
/***/ 166:
/*!***************************************!*\
  !*** D:/项目/oldHome/network/affirm.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getAffirmInfo = getAffirmInfo;exports.placeOrder = placeOrder;
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 17));

var _dealUrl = __webpack_require__(/*! @/utils/dealUrl */ 19);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 引入ajax
// 引入替换Url的方法
// 获取订单详情
function getAffirmInfo(cartId, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/auth_api/chai_order'),
    data: {
      cartId: cartId },
...
// 提交订单
function placeOrder(str, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/auth_api/chai_create_order'),
    data: {
      str: str },
...
/***/ 175:
/*!***********************************************!*\
  !*** D:/项目/oldHome/network/getProfileData.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getProfileData = getProfileData;exports.getProfileAllAddress = getProfileAllAddress;exports.addAddress = addAddress;exports.getUserDiscount = getUserDiscount;exports.getAddress = getAddress;exports.getAllAddress = getAllAddress;exports.setDefaultAddress = setDefaultAddress;exports.removeAddress = removeAddress;exports.profileCollect = profileCollect;exports.getCollectStore = getCollectStore;exports.userOrder = userOrder;exports.getUserDiscounts = getUserDiscounts;
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http.js */ 17));


var _dealUrl = __webpack_require__(/*! @/utils/dealUrl */ 19);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 登录注册相关的方法方法
// 引入替换Url的方法
// 获取个人信息
function getProfileData(token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/user_api/my'),
    header: {
      token: token } });
...
// 获取用户所有地址
function getProfileAllAddress(token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/user_api/user_address_list'),
    header: {
      token: token },
...
// 添加、修改收货地址
function addAddress(data, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/user_api/edit_user_address'),
    data: {
      id: data.id,
...
// 获取个人优惠信息
function getUserDiscount(types, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/coupons_api/get_use_coupons'),
    data: {
      types: types },
...
function getAddress(token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/user_api/user_default_address'),
    header: {
      token: token },
...
// 设置用户默认收货地址
function setDefaultAddress(addressId, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/user_api/set_user_default_address'),
    data: {
      addressId: addressId },
...
// 删除用户地址方法
function removeAddress(addressId, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/user_api/remove_user_address'),
    data: {
      addressId: addressId },
...
// 获取用户的收藏
function profileCollect(page, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/store_api/get_user_collect_product'),
    data: {
      limit: 5,
      page: page },
...
// 获取收藏店铺列表
function getCollectStore(page, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/public_api/shop_collect_list'),
    data: {
      limit: 5,
      page: page },
...
// 个人订单
function userOrder(type, page, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/user_api/get_user_order_list'),
    data: {
      limit: 5,
      type: type,
      page: page },
...
// 获取用户优惠券
function getUserDiscounts(types, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/coupons_api/get_use_coupons'),
    data: {
      types: types },
...
/***/ 18:
/*!***************************************!*\
  !*** D:/项目/oldHome/network/detail.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getDetailData = getDetailData;exports.getAddCart = getAddCart;exports.payNow = payNow;exports.getShopDiscount = getShopDiscount;exports.getDisCount = getDisCount;exports.collectProduct = collectProduct;exports.unCollectProduct = unCollectProduct;exports.unCollectProduct2 = unCollectProduct2;exports.getStoreInfo = getStoreInfo;exports.collectStoring = collectStoring;exports.unCollectStore = unCollectStore;
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 17));

var _dealUrl = __webpack_require__(/*! @/utils/dealUrl */ 19);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 引入ajax
// 引入替换Url的方法
// 获取商品详情页的信息
function getDetailData(shopId, token) {
  return (0, _http.default)({
    method: "GET",
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/store_api/details'),
    data: {
      id: shopId },
...
// 添加购物车方法
function getAddCart(option, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/auth_api/set_cart'),
    data: {
...
// 立即购买方法
function payNow(option, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/auth_api/now_buy'),
    method: "GET",
    data: {
      productId: option.productId,
      cartNum: option.cartNum,
...
// 根据商铺id获取优惠信息
// id:商铺id
function getShopDiscount(id, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/coupons_api/get_shop_coupon'),
    data: {
      limit: 20,
      page: 1,
      shop_id: id },
...
// 优惠券领取接口
function getDisCount(couponId, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/coupons_api/user_get_coupon'),
    data: {
      couponId: couponId //购物券id
    },
    header: {
      token: token } });
...
*/
function collectProduct(productId, category, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/store_api/collect_product'),
    data: {
      productId: productId,
      category: category },
...
// 取消收藏接口
function unCollectProduct(productId, category, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/store_api/uncollect_product'),
    data: {
      productId: productId,
      category: category },
...
// 取消收藏接口2
function unCollectProduct2(productId, token) {
...
// 获取店铺信息
function getStoreInfo(shop_id, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/store_api/shop_index'),
    data: {
      shop_id: shop_id },
...
// 收藏店铺
function collectStoring(shop_id, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/public_api/shop_collect'),
    data: {
      shop_id: shop_id },
...
// 取消收藏店铺
function unCollectStore(shop_id, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/public_api/del_collect'),
    data: {
      shop_id: shop_id //收藏id 批量删除 逗号拼接 1,2
    },
    header: {
      token: token } });
...
/***/ 19:
/*!**************************************!*\
  !*** D:/项目/oldHome/utils/dealUrl.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.replaceImage = replaceImage;exports.replaceList = replaceList;exports.resDealImage = resDealImage;exports.replaceImages = replaceImages;exports.addUrl = addUrl;exports.splitAddress = splitAddress;exports.getAddress = getAddress;var _const = __webpack_require__(/*! @/common/const */ 20);

var _area = _interopRequireDefault(__webpack_require__(/*! @/components/w-picker/city-data/area */ 21));
var _city = _interopRequireDefault(__webpack_require__(/*! @/components/w-picker/city-data/city */ 22));
var _province = _interopRequireDefault(__webpack_require__(/*! @/components/w-picker/city-data/province */ 23));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 导入地区文件
//区
//市
//省
// 替换单个Url的路径
function replaceImage(str) {var reg = new RegExp("".concat(_const.HOSTWWW));return str.replace(reg, _const.HOST);
}
...
// 处理res图片
function resDealImage(res, list) {
  var arr = replaceList(res.data.data);
  list = res.data.data;
...
// 替换图片列表
function replaceImages(list) {
  return list.map(function (item) {return replaceImage(item);});
}
...
function addUrl(path) {
  console.log(path);
  console.log(_const.HOST + '/' + path);
  return _const.HOST + '/' + path;
}
...
// 对地区文件进行处理返回数据格式
function getAddress(area, city, province) {
  var arr = [];
...
/***/ 20:
/*!*************************************!*\
  !*** D:/项目/oldHome/common/const.js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.TOKEN = exports.HOSTWWW = exports.HOST = void 0; // 定义主机
var HOST = '192.168.1.13';exports.HOST = HOST;
var HOSTWWW = 'www.test.com';exports.HOSTWWW = HOSTWWW;

var TOKEN = 'ebf86fef96684ca25be0c07bc58f8831297810122d56940ed83020c960656e32fa2229cfda503c04e7cd434be889d4e70e35d7de6077dbd6c02db9f58618a6d1';exports.TOKEN = TOKEN;

/***/ }),

/***/ 21:
/*!***********************************************************!*\
  !*** D:/项目/oldHome/components/w-picker/city-data/area.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 22:
/*!***********************************************************!*\
  !*** D:/项目/oldHome/components/w-picker/city-data/city.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 23:
/*!***************************************************************!*\
  !*** D:/项目/oldHome/components/w-picker/city-data/province.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 232:
/*!***************************************!*\
  !*** D:/项目/oldHome/utils/dealData.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.formatDate = formatDate; /**
                                                                                                             * 
                                                                                                             * @param {时间戳} date 
...
/***/ 30:
/*!*************************************!*\
  !*** D:/项目/oldHome/network/Home.js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getHomeData = getHomeData;exports.getDetailData = getDetailData;exports.secKillData = secKillData;exports.getSecKillData = getSecKillData;exports.getCombinationListData = getCombinationListData;exports.getDiscounts = getDiscounts;
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 17));

var _dealUrl = __webpack_require__(/*! @/utils/dealUrl */ 19);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 引入ajax
// 引入替换Url的方法
// 主页数据:
function getHomeData() {return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/public_api/index') });
...
function getDetailData() {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/store_api/get_product_list') });

}


// 获取秒杀页面数据
function secKillData(time, pages) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/seckill_api/seckill_list'),
    data: {
      time: time,
      offset: (pages - 1) * 5 + 1,
      limit: 5 },
...
// 获取秒杀时间列表
function getSecKillData() {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/seckill_api/seckill_index') });

}


// 获取拼团数据
function getCombinationListData(pages) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/pink_api/get_combination_list'),
    method: "POST",
    data: {
      limit: 5,
      offset: (pages - 1) * 5 + 1 } });
...
// 获取优惠券列表
function getDiscounts(page, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/coupons_api/get_issue_coupon_list'),
    data: {
      limit: 5,
      page: page },
...
/***/ 355:
/*!**************************************!*\
  !*** D:/项目/oldHome/network/skill.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getDetailSkill = getDetailSkill;
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http */ 17));
...
// 获取秒杀详情
function getDetailSkill(id, token) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/seckill_api/seckill_detail'),
    data: {
      id: id },
...
/***/ 404:
/*!**************************************!*\
  !*** D:/项目/oldHome/network/login.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.login = login;exports.register = register;exports.sendCode = sendCode;exports.resetPwd = resetPwd;
var _http = _interopRequireDefault(__webpack_require__(/*! @/common/http.js */ 17));
...
function login(option) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/public_api/user_login'),
    method: "POST",
    data: {
      phone: option.phone,
      pwd: option.pwd } });
...
function register(option) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/public_api/user_register'),
    method: "POST",
    data: {
      phone: option.phone,
      code: option.code,
...
function sendCode(phone) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/public_api/send_sms_code'),
    method: "GET",
    data: {
      phone: phone } });
...
function resetPwd(option) {
  return (0, _http.default)({
    url: (0, _dealUrl.replaceImage)('http://www.test.com/ebapi/public_api/reset_pwd'),
    method: "POST",
    data: {
      phone: option.phone,
      pwd: option.pwd,
...
/***/ 458:
/*!*****************************************************!*\
  !*** D:/项目/oldHome/components/jyf-Parser/Parser.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
 //Parser.js
var Tokenizer = __webpack_require__(/*! ./Tokenizer.js */ 459);
var DomHandler = __webpack_require__(/*! ./DomHandler.js */ 460);
var trustAttrs = {
  align: true,
  alt: true,
...
/***/ 459:
/*!********************************************************!*\
  !*** D:/项目/oldHome/components/jyf-Parser/Tokenizer.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 460:
/*!*********************************************************!*\
  !*** D:/项目/oldHome/components/jyf-Parser/DomHandler.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var CssHandler = __webpack_require__(/*! ./CssHandler.js */ 461);

var CanIUse = __webpack_require__(/*! ./api.js */ 462).versionHigherThan('2.7.1');
...
/***/ 461:
/*!*********************************************************!*\
  !*** D:/项目/oldHome/components/jyf-Parser/CssHandler.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 462:
/*!**************************************************!*\
  !*** D:/项目/oldHome/components/jyf-Parser/api.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = {
  ...
  html2nodes: function html2nodes(html, tagStyle) {
    var Parser = __webpack_require__(/*! ./Parser.js */ 458);
...
/***/ 491:
/*!*****************************************************!*\
  !*** D:/项目/oldHome/components/w-picker/w-picker.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!*************************************************!*\
  !*** D:/项目/oldHome/pages.json?{"type":"style"} ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/Home/home": {}, "pages/Home/Native/native": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "老家特产" }, "pages/Home/Native/address": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "特产馆" }, "pages/Home/Seckilltime/seckilltime": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "限时秒杀" }, "pages/Home/BookingList/bookingList": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "拼团" }, "pages/Home/Integral/integralShop": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "积分商城" }, "pages/Home/Integral/intrgralDetail": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "积分明细" }, "pages/Home/Integral/recordList": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "兑换记录" }, "pages/Home/Government/government": { "navigationBarBackgroundColor": "#FFFFFF" }, "pages/Home/Government/articless": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "新闻详情" }, "pages/Home/PublicMessage/publicmessage": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "公益信息" }, "pages/Home/PublicMessage/invite/invite": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "招聘信息" }, "pages/Home/PublicMessage/invite/issueinvite": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "发布" }, "pages/Home/PublicMessage/supply/supply": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "供求信息" }, "pages/Home/PublicMessage/supply/issuesupply": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "发布" }, "pages/Home/PublicMessage/publicdetail": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "信息详情" }, "pages/Classify/classify": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "商品分类" }, "pages/ShoopingCart/shoopingCart": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "购物车", "navigationStyle": "custom" }, "pages/My/my": { "navigationBarBackgroundColor": "#CD3233" }, "pages/My/MyshopMessage/collect": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "商品收藏" }, "pages/My/MyshopMessage/attention": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "收藏店铺" }, "pages/My/address/AllAddress": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "我的地址" }, "pages/My/address/addAddress": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "添加地址" }, "pages/My/Enter/enter": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "商家入驻" }, "pages/My/Discounts/mydiscounts": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "优惠券" }, "pages/My/Discounts/DiscpuntsCentent": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "领券中心" }, "pages/My/MyBooking/mybooking": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "我的拼团" }, "pages/My/Seeting/seeting": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "设置" }, "pages/My/Seeting/rule": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "规则公告" }, "pages/My/Inform/inform": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "消息" }, "pages/My/MyOrder/myorder": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "我的订单" }, "pages/My/MyOrder/orderdetail": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "订单详情" }, "pages/My/MyOrder/refund": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "申请退款" }, "pages/My/MyBooking/refund/refund": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "退款/售后" }, "pages/My/MyBooking/refund/refundMessage": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "退款" }, "pages/My/Inform/Logistics/logistics": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "物流通知" }, "pages/My/Inform/Chat/chat": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "聊天" }, "pages/My/Inform/System/system": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "系统通知" }, "pages/My/Inform/Enter/enter": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "入驻通知" }, "pages/ShopDetails/shopDetails": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "商品详情" }, "pages/ShopDetails/seckillTime": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "商品详情" }, "pages/ShopDetails/groubBooking": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "商品详情" }, "pages/ShopDetails/affirm/affirmOrder": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "确认订单" }, "pages/ShopDetails/StoreDetails/storedetails": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "店铺详情", "titlePenetrate": "YES" }, "pages/PayOrder/payOrderMessage/payorderMessage": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "拼团" }, "pages/ShopDetails/informtion/informtion": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "客服" }, "pages/login/login": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "登录" }, "pages/login/register": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "注册" }, "pages/login/forget": { "navigationBarBackgroundColor": "#FFFFFF", "navigationBarTitleText": "忘记密码" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": " ", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!************************************************!*\
  !*** D:/项目/oldHome/pages.json?{"type":"stat"} ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__EA8B4CA" };exports.default = _default;
